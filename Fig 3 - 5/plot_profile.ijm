...
//The output files are csv files with the following columns:
	...
	//Y_pre_Cx: Baseline fluorescent values for each point along the polyline in channel x (0 = CytoRCaMP, 1 = MitoGCaMP)
	//Y-bg_pre_Cx: Y_pre_Cx substracting background
	//Y_post_Cx: Poststim fluorescent values for each point along the polyline in channel x (0 = CytoRCaMP, 1 = MitoGCaMP)
